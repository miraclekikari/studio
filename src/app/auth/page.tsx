      ...
      <main className="flex-1 flex items-center justify-center p-4 py-12">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center space-y-2">
            ...
            <h1 className="text-3xl font-headline font-bold text-slate-900 tracking-tight">Studio Library</h1>
            <p className="text-slate-500">Authentification sécurisée via Supabase</p>
          </div>
